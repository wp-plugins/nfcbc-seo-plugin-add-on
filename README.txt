...
Click on the link in your comment e-mail notification or in the comment list (admin -> your comments) to let a follow link become nofollow or the nofollow link follow again.
...
This happens only if you allow those links. Nofollow Case by Case has an output filter that can not modify author links generated from other plugins if they grab those links directly from the database. If you link to and from your comments you will have no problem. 
...
= NFCBC SEO PLUGIN ADD-ON 1.2 =

New feature for WordPress 2.7+: Added support for comment moderation sub pages. You will now stay on that page you were working on when you changed a follow or nofollow link. 
