...
Added support for comment moderation sub pages (comment status: all, moderated, approved or spam). After modifying a link you will now stay on the you were working on page. 
