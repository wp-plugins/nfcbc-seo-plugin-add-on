...
= Why does my Recent Comments Plugin add /dontfollow to outgoing links? = 

This happens only if you allow those links. Nofollow Case by Case has an output filter that does not modify those links. 
...
Nofollow can be removed now without having to edit the link directly (added FCBC option) and /dontfollow can not be set twice anymore. 
