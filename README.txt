...
This happens only if you allow those links. Nofollow Case by Case has an output filter 

that can not modify author links generated from other plugins if they grab those links 

directly from the database. If you link to and from your comments you will have no problem. 
